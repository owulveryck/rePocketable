# Contributing to the rePocketable project

Hi there! We're thrilled that you'd like to contribute to the rePocketable project/product. 
...
Think you found a bug? Please check [the list of open issues](https://github.com/owulveryck/rePocketable/issues) to see if your bug has already been reported. If it hasn't please [submit a new issue](https://github.com/owulveryck/rePocketable/issues/new).
...
[Open an issue](https://github.com/owulveryck/rePocketable/issues/new) which describes the feature you would like to see, why you want it, how it should work, etc.
...
* [Good first issues](https://github.com/owulveryck/rePocketable/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) - issues which should only require a few lines of code and a test or two
* [Help wanted issues](https://github.com/owulveryck/rePocketable/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22) - issues which may be a bit more involved, but are specifically seeking community contributions
...
5. Push to your fork and [submit a pull request](https://github.com/owulveryck/rePocketable/compare)
...
`GO111MODULES=off go get github.com/owulveryck/rePocketable`
